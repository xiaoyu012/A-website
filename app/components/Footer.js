        ...
        <div className="mb-10 py-6 px-4 sm:px-6 rounded-xl bg-gray-800 border border-gray-700">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="text-xl font-bold text-white mb-2">{t('footer.openSource.title')}</h3>
              <p className="text-gray-300 max-w-2xl">
                {t('footer.openSource.description')}
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {t('footer.openSource.viewProjects')}
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-gray-300 tracking-wider uppercase">{t('footer.navigation')}</h3>
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/" className="text-base text-gray-400 hover:text-white">{t('navigation.home')}</Link>
                  </li>
                  <li>
                    <Link href="/blog" className="text-base text-gray-400 hover:text-white">{t('navigation.blog')}</Link>
                  </li>
                  <li>
                    <Link href="/about" className="text-base text-gray-400 hover:text-white">{t('navigation.about')}</Link>
                  </li>
                  <li>
                    <Link href="/projects" className="text-base text-gray-400 hover:text-white">{t('navigation.projects')}</Link>
                  </li>
                  <li>
                    <Link href="/contact" className="text-base text-gray-400 hover:text-white">{t('navigation.contact')}</Link>
                  </li>
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-gray-300 tracking-wider uppercase">{t('footer.blogCategories')}</h3>
                <ul className="mt-4 space-y-4">
                  <li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-gray-300 tracking-wider uppercase">{t('footer.resources')}</h3>
                <ul className="mt-4 space-y-4">
                  <li>
                    <a href="/resources" className="text-base text-gray-400 hover:text-white">{t('footer.frontendResources')}</a>
                  </li>
                  <li>
                    <a href="/snippets" className="text-base text-gray-400 hover:text-white">{t('footer.codeSnippets')}</a>
                  </li>
                  <li>
                    <a href="/newsletter" className="text-base text-gray-400 hover:text-white">{t('footer.techNewsletter')}</a>
                  </li>
                  <li>
                    <a href="/books" className="text-base text-gray-400 hover:text-white">{t('footer.recommendedBooks')}</a>
                  </li>
                </ul>
              </div>
              <div className="mt-12 md:mt-0">
