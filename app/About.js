...
export default function About() {
  ...
  return (
    <div id="about" ref={sectionRef} className="py-16 bg-white dark:bg-gray-900 overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* 背景装饰 */}
        <div className="absolute top-40 right-0 w-96 h-96 bg-primary-50 dark:bg-primary-900/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"></div>
        ...
        <div className={`lg:text-center transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="mt-4 max-w-3xl text-xl text-gray-600 dark:text-gray-300 mx-auto">
            拥有1年前端开发经验，专注于创造优美、高效且用户友好的Web应用
          </p>
        </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-gradient-to-r from-primary-500 to-secondary-600 p-1 rounded-xl shadow-xl">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg">
                ...
                <h3 className="text-xl font-bold text-center text-gray-900 dark:text-gray-100">小遇</h3>
                <p className="text-center text-primary-600 dark:text-primary-400 font-medium">前端开发工程师 & 技术博主</p>
                ...
                <div className="mt-6 flex justify-center space-x-4">
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">
                  ...
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-blue-400 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                    </svg>
                  </a>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
